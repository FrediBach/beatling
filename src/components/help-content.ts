...
export const HELP_CHAPTERS: HelpChapter[] = [
  ...
  },
  {
    ...
    cards: [
      ...
      { title: "Four different colors", text: "Distortion adds grit with Drive and Tone. Reverb adds space with Damping for its brightness. Delay offers Time in milliseconds, Feedback for repeats and Tone for their color. Parallel Compressor uses Threshold, Ratio, Attack and Release to add controlled punch and sustain." },
