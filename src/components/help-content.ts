...
export const HELP_CHAPTERS: HelpChapter[] = [
  ...
  },
  {
    ...
    cards: [
      ...
      { title: "Euclidean scales", text: "Choose Euclidean Quantizer as a block type. In its Patch panel, select a Pitch CV input from a Modulator. Steps divides one octave (12 gives semitones), Fill selects evenly spaced notes, and Rotate shifts the scale. Modulate Fill or Rotate to change it on the block’s clock, or use a rhythm series for changing scales. Route its CV to Bassline or Lead V/Oct at 100% depth and switch the voice’s Quantizer Off. Root, octave and Tune still transpose. Fill 0 passes pitch through." },
