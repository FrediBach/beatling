...
describe("multiple modulation targets", () => {
  ...
  it("migrates legacy patch and arrangement routing and preserves v11 round trips", () => {
    ...
    expect(patch.format).toBe("euclid-grid.v11");
    ...
    expect(normalizeArrangement(arrangement, patch).format).toBe("euclid-grid.arrangement.v11");
  });
