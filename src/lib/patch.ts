...
const STORAGE_KEY = "egs.patch.v9";
...
export function createDemoPatch(volume = 72): Patch {
  ...
  return { format: "euclid-grid.v9", bpm: 124, rate: 4, swing: 12, vol: volume, blocks, voices, effects };
}
