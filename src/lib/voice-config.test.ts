...
it("migrates v9 patch and arrangement storage with neutral voice defaults and saves v27", () => {
  ...
  expect(arrangement.format).toBe("euclid-grid.arrangement.v27");
  ...
  expect(JSON.parse(localStorage.getItem("egs.patch.v27")!)).toEqual(migrated);
  expect(JSON.parse(localStorage.getItem("egs.arrangement.v27")!)).toEqual(arrangement);
});
