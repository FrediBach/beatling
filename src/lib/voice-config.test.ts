...
it("migrates v9 patch and arrangement storage with neutral voice defaults and saves v25", () => {
  ...
  expect(migrated.format).toBe("euclid-grid.v25");
  ...
  expect(arrangement.format).toBe("euclid-grid.arrangement.v25");
  ...
  expect(JSON.parse(localStorage.getItem("egs.patch.v25")!)).toEqual(migrated);
  expect(JSON.parse(localStorage.getItem("egs.arrangement.v25")!)).toEqual(arrangement);
});
